...
1. **[SuperGlue](https://huggingface.co/docs/transformers/model_doc/superglue)** (from MagicLeap) released with the paper [SuperGlue: Learning Feature Matching with Graph Neural Networks](https://arxiv.org/abs/1911.11763) by Paul-Edouard Sarlin, Daniel DeTone, Tomasz Malisiewicz and Andrew Rabinovich.
