...
1. **[SuperGlue](https://huggingface.co/docs/transformers/model_doc/superglue)** (de MagicLeap) a été publié dans l'article [SuperGlue: Learning Feature Matching with Graph Neural Networks](https://arxiv.org/abs/1911.11763) par Paul-Edouard Sarlin, Daniel DeTone, Tomasz Malisiewicz et Andrew Rabinovich.
